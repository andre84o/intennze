...
export default async function AdminPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-slate-950 text-white pt-24 px-6">
      {/* Background effects */}
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* Content Area */}
        <div className="mt-8 p-8 bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl">
