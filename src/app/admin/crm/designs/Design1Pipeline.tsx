            ...
            <>
              ...
              <div className="space-y-5 min-w-0">
                ...
                <div className="space-y-3 min-w-0">
                  ...
                  {(selected.address || selected.postal_code || selected.city) && <div className="flex items-start gap-3 text-sm text-slate-700 min-w-0"><svg className="w-4 h-4 text-slate-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" /></svg><span className="min-w-0">{[selected.address, [selected.postal_code, selected.city].filter(Boolean).join(" ")].filter(Boolean).join(", ")}</span></div>}
                  {selected.contact_person && <div className="flex items-center gap-3 text-sm text-slate-700 min-w-0"><svg className="w-4 h-4 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /></svg><span className="truncate">{selected.contact_person}</span></div>}
                </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-1.5">
                          ...
                          <p className="text-xs font-bold uppercase tracking-wider text-violet-600">Claude</p>
                        </div>
                        {suggestions.map((s, i) => (
