// Custom CRM sidebar icon (headset, from public/icons/headset.svg). Rendered
// inline with fill="currentColor" so it inherits the sidebar's colour states
// (white when the nav item is active, violet on hover) like the other icons.
export default function CrmIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 256 256"
