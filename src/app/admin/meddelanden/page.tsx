              ...
              <button
                ...
                className={`w-full text-left p-4 rounded-xl border transition-all ${
                  selectedMessage?.id === message.id
                    ...
                    : "bg-white border-blue-200 hover:border-blue-300 shadow-sm ring-1 ring-blue-100"
                }`}
              >
          ...
          {selectedMessage ? (
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm sticky top-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 flex gap-3">
                <a
                  href={`mailto:${selectedMessage.email}`}
                  className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-center transition-colors font-medium shadow-sm"
                >
                  Svara via e-post
                </a>
                {selectedMessage.phone && (
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-12 flex items-center justify-center shadow-sm h-fit">
