...
export const dict: Record<Lang, Record<string, string>> = {
  sv: {
    ...
    message_label: "Vad behöver du hjälp med?",
    message_placeholder:
      "Beskriv kort ditt företag, vad du behöver och vilka funktioner du önskar",
    submit: "Skicka",
    sending: "Skickar…",
    sent: "Skickat!",
  ...
  en: {
    ...
    message_placeholder:
      "Briefly describe your business, what you need and any features you require",
    submit: "Send",
    sending: "Sending…",
    sent: "Sent!",
