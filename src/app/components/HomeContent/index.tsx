    ...
    <main className="min-h-screen w-full flex flex-col bg-slate-950 text-white overflow-x-hidden">
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-start gap-7 md:gap-11">
            {/* React */}
            ...
            {/* Next.js */}
            <div className="group flex flex-col items-center gap-2 w-14">
              <div className="w-14 h-14 flex items-center justify-center bg-slate-800/50 rounded-xl border border-slate-700 group-hover:border-white/50 transition-colors">
            ...
            <div className="group flex flex-col items-center gap-2 w-14">
              ...
              <span className="text-xs text-slate-500">Woo</span>
            </div>

            {/* Shopify */}
            <div className="group flex flex-col items-center gap-2 w-14">
              <div className="w-14 h-14 flex items-center justify-center bg-slate-800/50 rounded-xl border border-slate-700 group-hover:border-green-500/50 transition-colors">
              ...
              <span className="text-xs text-slate-500">Shopify</span>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <h3 className="text-xl md:text-2xl font-semibold mb-3">
              {sv ? "Vilken lösning passar dig bäst?" : "Which solution suits you best?"}
            </h3>
            <p className="text-slate-400 mb-6 max-w-md mx-auto">
              {sv
                ? "Vi hjälper dig hitta rätt väg framåt – boka en gratis konsultation idag."
