        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-16">
            ...
            <div>
              ...
              <p className="text-slate-400 text-center text-sm mb-8 max-w-xl mx-auto">
                {sv
                  ? "Behöver ni en enkel webbplats eller webshop? Vi bygger även skräddarsydda lösningar med WordPress, WooCommerce och Shopify."
                  : "Need a simple website or webshop? We also build tailored solutions with WordPress, WooCommerce and Shopify."}
              </p>
              <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                {/* WordPress */}
                <div className="flex flex-col items-center gap-2 group">
