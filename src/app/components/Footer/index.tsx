...
export default function Footer() {
  ...
  const isLandingPage = pathname === "/kontakta-oss-idag";
  ...
  return (
    <footer className="relative bg-slate-950 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 md:px-6 md:py-16">
          ...
          <div className="bg-slate-900/50 rounded-xl border border-slate-800/50 p-4 space-y-3">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-slate-400">
                  {lang === "sv" ? "Svarar inom 24h" : "Response within 24h"}
                </span>
              </div>
              <div className="flex items-center gap-3">
                <svg
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-center gap-3">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-slate-800/50 border border-slate-700 hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all duration-300 group"
                aria-label="LinkedIn"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-slate-800/50 border border-slate-700 hover:border-purple-500/50 hover:bg-purple-500/10 transition-all duration-300 group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-slate-800/50 border border-slate-700 hover:border-fuchsia-500/50 hover:bg-fuchsia-500/10 transition-all duration-300 group"
                aria-label="Facebook"
              >
                <svg
          ...
          <div className="pt-2">
            {isLandingPage ? (
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg text-sm font-semibold hover:from-purple-500 hover:to-fuchsia-500 transition-all duration-300 group"
              >
                {t.nav_contact}
                <svg
        ...
        {/* Bottom Bar */}
        <div className="mt-10 md:mt-16 pt-6 md:pt-8 border-t border-slate-800">
